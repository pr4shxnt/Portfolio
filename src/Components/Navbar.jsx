        ...
        <div className="hidden md:flex justify-between w-[65%]">
          <ul className="flex items-center">
            ...
            <div className="relative" ref={projectsDropdownRef}>
              ...
              {showProjectsDropdown && (
                <div className="absolute w-[33vw] top-12 -left-44 rounded-lg bg-black bg-opacity-50 backdrop-blur-sm p-1 shadow-lg">
          ...
          <div className="relative" ref={profilesDropdownRef}>
            ...
            {showProfilesDropdown && (
              <ul className="absolute bg-transparent text-white top-16 rounded-lg w-[15vw] right-0 p-2 shadow-lg">
                ...
                <li className="p-2 flex items-center text-gray-400 hover:text-[#705ADD] ease-in-out duration-300 transition-all gap-2">
                  <Link to="/github" onClick={handleLinkClick}>
                    <Github /> Github
                  </Link>
                </li>
